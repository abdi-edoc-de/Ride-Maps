...
import { addMulPoints, createLayer, fetchPoints } from "../../Utils/Utils";

export const OverAllHeatMap = () => {
  const mapRef = useRef();
  ...
  useEffect(() => {
    ...
    loadModules(
      ...
      var layer = createLayer(addMulPoints(fetchPoints(), Graphic),FeatureLayer)
      map.add(layer)
